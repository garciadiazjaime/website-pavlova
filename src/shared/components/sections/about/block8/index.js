      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-sm-6 col-xs-12">
            ...
            <a className={style.button} href={normalizeImageUrl('/docs/horarios-pavlova.jpg')} title={buttons.button1.title} target="_blank">DESCARGAR<SVG network="arrow_down" className={style.svg}/></a>
          </div>
          <div className="col-sm-6 col-xs-12">
